...
const Socialbuttom = () => {
  return (
    <div className='flex  space-x-5 '>
        ...
        <a  aria-label="Find us on LinkedIn"
            target="_blank" rel="noopener">
            <svg className=" h-8 w-8 text-black cursor-pointer " viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a aria-label="Find us on Instagram" target="_blank"
            rel="noopener">
            <svg className="h-8 w-8 text-black cursor-pointer" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a aria-label="Find us on Twitter" target="_blank" rel="noopener">
            <svg className="h-8 w-8 text-black cursor-pointer" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
